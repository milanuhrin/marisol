...
import { SectionDividerWaveOneSide } from 'svg/SectionDividerWaveOneSide'; // Import the divider
...
export const Footer = () => {
  ...
  return (
    <div className="relative bg-[#e6f6ff]">
      {/* Add Divider at the top, rotated 180 degrees */}
        ...
        >
          <div className="flex items-center justify-center space-x-8 text-xl text-gray-700">
            ...
            >
              ...
              <span>marisolseaview@gmail.com</span>
            </motion.div>
          </div>
        </motion.div>
      </motion.footer>
