      ...
      <div className="py-8 max-w-screen-lg mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mt-8 mx-6 sm:mx-12 lg:mx-20 ">
          {[
            ...
            { title: 'Vodné športy', image: 'wakepark.png', description: 'Pre milovníkov vodných športov je moderný wakepark Mosquito ideálnou voľbou. Nachádza sa len 6 km od apartmánu. Môžete vyskúšať aj nezabudnuteľný adrenalínový zážitok z lietania nad morom - parasailing.' },
